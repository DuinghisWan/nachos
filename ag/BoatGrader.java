...
public class BoatGrader {
    ...
    /*
     * ChildRowToMolokai should be called when a child pilots the boat from Oahu to
     * Molokai
     */
    ...
    /*
     * ChildRowToOahu should be called when a child pilots the boat from Molokai to
     * Oahu
     */
    ...
    /*
     * AdultRowToMolokai should be called when a adult pilots the boat from Oahu to
     * Molokai
     */
    ...
    /*
     * AdultRowToOahu should be called when a adult pilots the boat from Molokai to
     * Oahu
     */
