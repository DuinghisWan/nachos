...
public final class ElevatorBank implements Runnable {
	...
	/**
	 * Initialize this elevator bank with the specified number of elevators and the
	 * specified number of floors. The software elevator controller must also be
	 * specified. This elevator must not already be running a simulation.
	 *
	...
	/**
	 * Run a simulation. Initialize all elevators and riders, and then fork threads
	 * to each of their <tt>run()</tt> methods. Return when the simulation is
	 * finished.
	 */
	public void run() {
		Lib.assertTrue(!simulationStarted);
