...
public interface ElevatorControls {
    ...
    /**
     * Move an elevator to another floor. The elevator's doors must be closed. If
     * the elevator is already moving and cannot safely stop at the specified floor
     * because it has already passed or is about to pass the floor, fails and
     * returns <tt>false</tt>. If the elevator is already stopped at the specified
     * floor, returns <tt>false</tt>.
     *
    ...
    /**
     * Return the current location of the elevator. If the elevator is in motion,
     ...
     * The <i>direction</i> argument should be one of the <i>dir*</i> constants in
     * the <tt>ElevatorBank</tt> class.
     *
     ...
     * events pending when an elevator interrupt occurs, so this method should be
