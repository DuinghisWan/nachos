...
public class NetworkLink {
	 ...
	 * reliability, between 0 and 1, is the probability that any particular packet
	 * will not get dropped by the network.
	 *
	 ...
	 *
	 * <p>
	 * The receive interrupt handler is called every time a packet arrives and can
	 * be read using <tt>receive()</tt>.
	 *
	 * <p>
	 * The send interrupt handler is called every time a packet sent with
	 * <tt>send()</tt> is finished being sent. This means that another packet can be
	 * sent.
	 *
	...
	/**
	 * The address of the network to which are attached all network links in this
	 * JVM. This is a hash on the account name of the JVM running this Nachos
	 * instance. It is used to help prevent packets from other users from
