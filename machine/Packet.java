...
public class Packet {
    ...
    /**
     * Allocate a new packet using the specified array of bytes received from the
     * network.
     *
    ...
    /**
     * The number of bytes in a link-layer packet header. The header is formatted as
     * follows:
     *
     * <table>
     * <tr>
    ...
    /**
     * The maximum length, in bytes, of a packet that can be sent or received on the
     * network.
     */
