...
public class NachosSecurityManager extends SecurityManager {
	...
	/**
	 * Return a privilege object for this security manager. This security manager
	 * must not be the active security manager.
	 *
	 ...
	 * group for a child thread of the current thread. The caller must be privileged
	 * in order to successfully create the thread.
	 *
