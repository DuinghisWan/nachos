...
public abstract class Privilege {
     ...
     * does not encapsulate privileged access until the machine devices fill it in.
     */
    public Privilege() {
    }
    ...
    /**
     * Add an <tt>exit()</tt> notification handler. The handler will be invoked by
     * exit().
     *
    ...
    public interface TCBPrivilege {
         ...
         * <tt>AutoGrader.runningThread()</tt> <i>must</i> call this method before
         * returning.
         *
